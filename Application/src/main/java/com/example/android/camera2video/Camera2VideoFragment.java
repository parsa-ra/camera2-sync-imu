...
public class Camera2VideoFragment extends Fragment
    ...
    /* Get information for all Logical Camera Devices  */
    public void CameraInfo(CameraManager manager) {
        try {
            String[] CameraIDs = manager.getCameraIdList();

            // Iteration over all logical cameras
            for (int i1 = 0; i1 < CameraIDs.length; i1++) {
                String output = String.format("Iteration #%d", i1);
                Log.i(TAG, output);

                String CameraID = CameraIDs[i1];
